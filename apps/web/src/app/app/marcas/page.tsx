    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Suas marcas</h1>
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          {marcas.map((m) => {
            ...
            return (
              <div
                key={m.id}
                className={`relative overflow-hidden rounded-2xl border-2 bg-white p-5 transition ${
                  isAtiva
              ...
              >
                {isAtiva && (
                  <div className="absolute right-3 top-3 inline-flex items-center gap-1 rounded-full bg-purple-100 px-2 py-0.5 text-[10px] font-semibold text-purple-700">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="mt-2 flex flex-wrap items-center gap-2 text-xs">
                      ...
                      {m.instagramConectado && (
                        <span className="inline-flex items-center gap-1 rounded-full bg-pink-100 px-2 py-0.5 text-pink-700">
