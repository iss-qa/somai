...
export function StepModo({ w }: { w: CriarWizardApi }) {
  return (
    <div className="mt-6 md:mt-10">
      <Header
        titulo="Como você quer gerar a imagem?"
        subtitulo="Escolha o método ideal. Ambos usam IA — diferem em custo, controle e flexibilidade."
      />
      <div className="mt-6 grid gap-3 md:grid-cols-2 md:gap-4">
        ...
        <BigCard
          ...
          subtitulo="Ótimo para carrosséis"
          price="0 créditos por slide"
          icon={<PenLine className="h-6 w-6" />}
          details={[
            'Templates pré-prontos preenchidos pela IA',
            '100% editáveis no editor',
